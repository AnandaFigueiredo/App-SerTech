    ...
    <>
      ...
      <div className="flex flex-col gap-3">
        <div className="bg-[#FFF7D6] border-l-4 border-[#E0B84E] rounded-lg px-4 py-3 flex items-center gap-3 shadow-sm">
          ...
          <p className="text-sm text-[#3f3f46]">Previsao de Parto da vaca 100 para daqui 2 dias</p>
        </div>
        <div className="bg-[#FFF7D6] border-l-4 border-[#E0B84E] rounded-lg px-4 py-3 flex items-center gap-3 shadow-sm">
          <span className="material-icons text-[#E0B84E]">warning</span>
          <p className="text-sm text-[#3f3f46]">Vaca 120 nao se alimentou direito hoje</p>
        </div>
        <div className="bg-[#FFF7D6] border-l-4 border-[#E0B84E] rounded-lg px-4 py-3 flex items-center gap-3 shadow-sm">
          <span className="material-icons text-[#E0B84E]">warning</span>
        ...
        <div className="bg-[#FFF7D6] border-l-4 border-[#E0B84E] rounded-lg px-4 py-3 flex items-center gap-3 shadow-sm">
          <span className="material-icons text-[#E0B84E]">warning</span>
          <p className="text-sm text-[#3f3f46]">Previsao de secagem da vaca 100 para daqui 2 dias</p>
        </div>
      </div>
