  ...
  return (
    <>
      <div className="flex items-center gap-2 text-[#6EB56B]">
        ...
        <h1 className="text-2xl font-bold text-[#1f2937]">Avisos Urgencia</h1>
      </div>
      ...
      <div className="flex flex-col gap-3">
        <div className="bg-[#FDEDED] border-l-4 border-[#D46A6A] rounded-lg px-4 py-3 flex items-center gap-3 shadow-sm">
          ...
          <p className="text-sm text-[#3f3f46]">O parto da vaca 100 esta previsto para hoje</p>
        </div>
        <div className="bg-[#FDEDED] border-l-4 border-[#D46A6A] rounded-lg px-4 py-3 flex items-center gap-3 shadow-sm">
          <span className="material-icons text-[#D46A6A]">report</span>
          <p className="text-sm text-[#3f3f46]">Vaca 120 nao se alimenta direito a 3 dias</p>
        </div>
        <div className="bg-[#FDEDED] border-l-4 border-[#D46A6A] rounded-lg px-4 py-3 flex items-center gap-3 shadow-sm">
          <span className="material-icons text-[#D46A6A]">report</span>
        ...
        <div className="bg-[#FDEDED] border-l-4 border-[#D46A6A] rounded-lg px-4 py-3 flex items-center gap-3 shadow-sm">
          <span className="material-icons text-[#D46A6A]">report</span>
          <p className="text-sm text-[#3f3f46]">Producao baixa</p>
        </div>
      </div>

      <div className="text-center text-xs text-gray-400 mt-2">Fim dos avisos de urgencia</div>
